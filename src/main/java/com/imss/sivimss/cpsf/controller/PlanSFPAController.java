...
public class PlanSFPAController {
	...
	@GetMapping("/consulta-pagos-mensuales")
	@CircuitBreaker(name = "msflujo", fallbackMethod = "fallbackGenerico")
	@Retry(name = "msflujo", fallbackMethod = "fallbackGenerico")
	@TimeLimiter(name = "msflujo")
	public CompletableFuture<Object> consultaPagosMensuales(Authentication authentication)	throws Throwable {
		Response<Object> response = planSFPAService.consultaPagoMensualPlanSfpa();
		return CompletableFuture.supplyAsync(() -> new ResponseEntity<>(response, HttpStatus.valueOf(response.getCodigo())));
	}
	
	@GetMapping("/consulta-pago-api")
	@CircuitBreaker(name = "msflujo", fallbackMethod = "fallbackGenerico")
	@Retry(name = "msflujo", fallbackMethod = "fallbackGenerico")
	@TimeLimiter(name = "msflujo")
	public CompletableFuture<Object> consultaPagosMensualesCodeKey(Authentication authentication)	throws Throwable {
		Response<Object> response = planSFPAService.consultaPagoApi();
		return CompletableFuture.supplyAsync(() -> new ResponseEntity<>(response, HttpStatus.valueOf(response.getCodigo())));
	}
